...
This chapter upgrades the abstract Stasheff package to object-indexed
\Ainf{}-categories. The public API consists of raw precategory data, chains,
their basic accessors, the Stasheff sum/property on a precategory, and the
packaged notion of an \Ainf{}-category.
...
For a chain and an index $i$, \lean{AInfinityCategoryTheory.AInfinityPreCategory.Chain.link} is the module of the $i$-th
composable morphism in that chain.
\end{definition}
